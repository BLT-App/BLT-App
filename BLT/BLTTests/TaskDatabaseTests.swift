...
class TaskDatabaseTests: XCTestCase {
    ...
    let exampleEvents: [DatabaseEvent] = [
        ...
        DatabaseEvent(item: exampleToDoItem,
                      event: .markedCompletedInFocusMode,
                      currentDate: Date(timeIntervalSinceNow: 1.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .created,
                      currentDate: Date(timeIntervalSinceNow: 2.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .markedCompletedInFocusMode,
                      currentDate: Date(timeIntervalSinceNow: 1.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .created,
                      currentDate: Date(timeIntervalSinceNow: 4.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .markedCompletedInFocusMode,
                      currentDate: Date(timeIntervalSinceNow: 1.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .created,
                      currentDate: Date(timeIntervalSinceNow: 5.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .markedCompletedInFocusMode,
                      currentDate: Date(timeIntervalSinceNow: 2.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .created,
                      currentDate: Date(timeIntervalSinceNow: 3.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
                      event: .markedCompletedInFocusMode,
                      currentDate: Date(timeIntervalSinceNow: 2.days.timeInterval)),
        DatabaseEvent(item: exampleToDoItem,
